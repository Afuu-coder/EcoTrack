    ...
    <section aria-labelledby="results-heading">
      ...
      >
        ...
        >
          ...
          <span
            className="font-sans"
            style={{ fontSize: 18, fontWeight: 400, marginLeft: 8, opacity: 0.6 }}
          >
            kg CO₂e/mo
          </span>
        </p>
        <p style={{ margin: '10px 0 0', fontSize: 14, color: 'var(--text-secondary)' }}>
          Grade <strong style={{ color, fontSize: 16 }}>{grade}</strong> — {label}
        </p>
        ...
        >
          {[
            ...
            <div key={lbl} style={{ textAlign: 'center' }}>
              <p
                className="font-display"
                style={{ margin: 0, fontSize: 22, fontWeight: 700, color: col }}
              >
                {val.toLocaleString()}
              </p>
            ...
            <div style={{ marginTop: 20, textAlign: 'left' }}>
              ...
              >
                ...
                <span style={{ fontWeight: 700, color: barColor }}>
                  {isAbove ? '+' : ''}
                  {pctVsParis}% {isAbove ? 'above' : 'below'} target
                </span>
              </div>
              <div
                role="progressbar"
      ...
      <div className="glass-panel" style={{ padding: '24px', margin: '24px 0' }}>
        <h3 className="section-title font-display" style={{ margin: '0 0 18px', fontSize: 18 }}>
          Emissions Breakdown
        </h3>
      ...
      {/* ── Comparisons ─────────────────────────────────────── */}
      <div className="glass-panel" style={{ padding: '24px', margin: '24px 0' }}>
        <h3 className="section-title font-display" style={{ margin: '0 0 12px', fontSize: 18 }}>
          How You Compare
        </h3>
        {comparisons.map(({ label, value, unit, neutral }) => (
          ...
          >
            ...
            >
              ...
              <span style={{ fontWeight: 400, opacity: 0.45, fontSize: 11, marginLeft: 4 }}>
                {unit}
              </span>
            </span>
          </div>
