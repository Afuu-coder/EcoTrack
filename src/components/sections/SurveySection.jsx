...
export default function SurveySection({
  ...
  return (
    <section aria-labelledby="survey-heading">
      <h2 id="survey-heading" className="section-title">Monthly Activity Survey</h2>
      ...
      <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px' }}>
        ...
        <InputField
          id="kmCar" label="Car distance" value={transport.kmCar}
          onChange={v => setTransport(p => ({ ...p, kmCar: v }))}
          unit="km/month" helpText="Total km driven in a personal vehicle this month"
        />
        <InputField
          id="kmBus" label="Bus / coach distance" value={transport.kmBus}
          onChange={v => setTransport(p => ({ ...p, kmBus: v }))}
          unit="km/month"
        />
        <InputField
          id="kmTrain" label="Train / metro distance" value={transport.kmTrain}
          onChange={v => setTransport(p => ({ ...p, kmTrain: v }))}
          unit="km/month"
        />
        <InputField
          id="flightHours" label="Flights this year (total)" value={transport.flightHours}
          onChange={v => setTransport(p => ({ ...p, flightHours: v }))}
          unit="hours/year" helpText="Total flight time in hours across all trips this year" max={500}
        />
      </div>
      ...
      <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px' }}>
        ...
        <SelectField
          id="dietType" label="Your diet pattern" value={diet.dietType}
      ...
      <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px' }}>
        ...
        <InputField
          id="kwhHome" label="Electricity usage" value={energy.kwhHome}
          onChange={v => setEnergy(p => ({ ...p, kwhHome: v }))}
          unit="kWh/month" helpText="Check your energy bill for monthly kWh usage" max={5000}
        />
        <SelectField
          id="energySource" label="Primary energy source" value={energy.energySource}
      ...
      <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px' }}>
        ...
        <InputField
          id="clothingItems" label="New clothing items" value={shopping.clothingItems}
          onChange={v => setShopping(p => ({ ...p, clothingItems: v }))}
          unit="items/year" max={200}
        />
        <InputField
          id="electronicsItems" label="New electronics" value={shopping.electronicsItems}
          onChange={v => setShopping(p => ({ ...p, electronicsItems: v }))}
          unit="items/year" max={50}
