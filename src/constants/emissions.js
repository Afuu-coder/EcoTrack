...
export const GCP_SERVICES = [
  {
    ...
    name: 'Firebase Auth',
    role: 'Identity',
    desc: 'Anonymous + social login, JWT token validation',
  },
  {
    icon: '🗄️',
    name: 'Cloud Firestore',
    role: 'Database',
    desc: 'Real-time NoSQL, user footprint time-series',
  },
  {
    icon: '🤖',
    name: 'Vertex AI',
    role: 'Insights',
    desc: 'Gemini Pro, fine-tuned on emissions datasets',
  },
  {
    icon: '📊',
    name: 'BigQuery',
    role: 'Analytics',
    desc: 'Aggregate analytics, cohort & trend analysis',
  },
  {
    icon: '🚀',
    name: 'Cloud Run',
    role: 'Backend',
    desc: 'Containerised Express API, auto-scales to zero',
  },
  {
    icon: '🌐',
    name: 'Firebase Hosting',
    role: 'CDN',
    desc: 'Global CDN, HTTPS enforced, HTTP/2 push',
  },
];
