    ...
    <div className="login-page">
      ...
      >
        ...
        <p className="login-subtitle">
          Sign in to track your carbon footprint, access AI-powered insights, and join the EcoTrack community.
        </p>
          ...
          {loading === 'google' ? (
            <span style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ animation: 'spin 1s linear infinite' }}>
                ...
                <path d="M12 2a10 10 0 0 1 10 10" stroke="#1f1f1f" strokeWidth="3" strokeLinecap="round"/>
              </svg>
              Signing in...
            </span>
          ) : (
        ...
        <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.07)' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 24, flexWrap: 'wrap' }}>
            {[
              ...
              <div key={item.text} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: 'var(--text-tertiary)' }}>
                <span>{item.icon}</span>
                {item.text}
              </div>
            ))}
